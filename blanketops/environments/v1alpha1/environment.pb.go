...
const file_blanketops_environments_v1alpha1_environment_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\v23.blanketops.environments.v1alpha1.EnvironmentStatusR\x06status\"\x9b\x06\n" +
	...
	"deployment\x12K\n" +
	"\x05route\x18\t \x01(\v25.blanketops.environments.v1alpha1.EnvironmentRouteRefR\x05route\x12Q\n" +
	"\apackage\x18\n" +
	" \x01(\v27.blanketops.environments.v1alpha1.EnvironmentPackageRefR\apackage\x12K\n" +
	"\x05build\x18\v \x01(\v25.blanketops.environments.v1alpha1.EnvironmentBuildRefR\x05build\x12c\n" +
	"\x0ebuild_triggers\x18\f \x03(\v2<.blanketops.environments.v1alpha1.EnvironmentBuildTriggerRefR\rbuildTriggers\")\n" +
...
var file_blanketops_environments_v1alpha1_environment_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_blanketops_environments_v1alpha1_environment_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_blanketops_environments_v1alpha1_environment_proto_goTypes = []any{
	(EnvironmentType)(0),               // 0: blanketops.environments.v1alpha1.EnvironmentType
	(*Environment)(nil),                // 1: blanketops.environments.v1alpha1.Environment
	(*EnvironmentSpec)(nil),            // 2: blanketops.environments.v1alpha1.EnvironmentSpec
	(*EnvironmentBuildRef)(nil),        // 3: blanketops.environments.v1alpha1.EnvironmentBuildRef
	(*EnvironmentBuildTriggerRef)(nil), // 4: blanketops.environments.v1alpha1.EnvironmentBuildTriggerRef
	(*EnvironmentServiceUnitRef)(nil),  // 5: blanketops.environments.v1alpha1.EnvironmentServiceUnitRef
	(*EnvironmentDeploymentRef)(nil),   // 6: blanketops.environments.v1alpha1.EnvironmentDeploymentRef
	(*EnvironmentRouteRef)(nil),        // 7: blanketops.environments.v1alpha1.EnvironmentRouteRef
	(*EnvironmentPackageRef)(nil),      // 8: blanketops.environments.v1alpha1.EnvironmentPackageRef
...
var file_blanketops_environments_v1alpha1_environment_proto_depIdxs = []int32{
	2,  // 0: blanketops.environments.v1alpha1.Environment.spec:type_name -> blanketops.environments.v1alpha1.EnvironmentSpec
	9,  // 1: blanketops.environments.v1alpha1.Environment.status:type_name -> blanketops.environments.v1alpha1.EnvironmentStatus
	0,  // 2: blanketops.environments.v1alpha1.EnvironmentSpec.environment_type:type_name -> blanketops.environments.v1alpha1.EnvironmentType
	5,  // 3: blanketops.environments.v1alpha1.EnvironmentSpec.service_units:type_name -> blanketops.environments.v1alpha1.EnvironmentServiceUnitRef
	6,  // 4: blanketops.environments.v1alpha1.EnvironmentSpec.deployment:type_name -> blanketops.environments.v1alpha1.EnvironmentDeploymentRef
	7,  // 5: blanketops.environments.v1alpha1.EnvironmentSpec.route:type_name -> blanketops.environments.v1alpha1.EnvironmentRouteRef
	8,  // 6: blanketops.environments.v1alpha1.EnvironmentSpec.package:type_name -> blanketops.environments.v1alpha1.EnvironmentPackageRef
	3,  // 7: blanketops.environments.v1alpha1.EnvironmentSpec.build:type_name -> blanketops.environments.v1alpha1.EnvironmentBuildRef
	4,  // 8: blanketops.environments.v1alpha1.EnvironmentSpec.build_triggers:type_name -> blanketops.environments.v1alpha1.EnvironmentBuildTriggerRef
