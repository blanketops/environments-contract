...
const file_blanketops_environments_v1alpha1_build_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\v2-.blanketops.environments.v1alpha1.BuildStatusR\x06status\"\xc0\x04\n" +
	"\tBuildSpec\x12\x14\n" +
	...
	"\x0fPHASE_CANCELLED\x10\x05BcZagithub.com/ntlaletsi70/blanketops-environments-contract/blanketops/environments/v1alpha1;v1alpha1b\x06proto3"
...
var file_blanketops_environments_v1alpha1_build_proto_depIdxs = []int32{
	...
	14, // 9: blanketops.environments.v1alpha1.BuildSpec.duration:type_name -> google.protobuf.Timestamp
	0,  // 10: blanketops.environments.v1alpha1.BuildStrategy.kind:type_name -> blanketops.environments.v1alpha1.BuildStrategy.Kind
	8,  // 11: blanketops.environments.v1alpha1.BuildPolicy.allowed_triggers:type_name -> blanketops.environments.v1alpha1.BuildTriggerPolicy
	9,  // 12: blanketops.environments.v1alpha1.BuildPolicy.retry:type_name -> blanketops.environments.v1alpha1.RetryPolicy
	1,  // 13: blanketops.environments.v1alpha1.BuildTriggerPolicy.type:type_name -> blanketops.environments.v1alpha1.BuildTriggerPolicy.Type
	2,  // 14: blanketops.environments.v1alpha1.BuildStatus.phase:type_name -> blanketops.environments.v1alpha1.BuildStatus.Phase
	14, // 15: blanketops.environments.v1alpha1.BuildStatus.start_time:type_name -> google.protobuf.Timestamp
	14, // 16: blanketops.environments.v1alpha1.BuildStatus.completion_time:type_name -> google.protobuf.Timestamp
