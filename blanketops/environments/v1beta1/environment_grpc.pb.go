...
const (
	EnvironmentService_CreateEnvironment_FullMethodName = "/blanketops.environments.v1beta1.EnvironmentService/CreateEnvironment"
	EnvironmentService_GetEnvironment_FullMethodName    = "/blanketops.environments.v1beta1.EnvironmentService/GetEnvironment"
	EnvironmentService_UpdateEnvironment_FullMethodName = "/blanketops.environments.v1beta1.EnvironmentService/UpdateEnvironment"
	EnvironmentService_PatchEnvironment_FullMethodName  = "/blanketops.environments.v1beta1.EnvironmentService/PatchEnvironment"
	EnvironmentService_ListEnvironments_FullMethodName  = "/blanketops.environments.v1beta1.EnvironmentService/ListEnvironments"
	EnvironmentService_DeleteEnvironment_FullMethodName = "/blanketops.environments.v1beta1.EnvironmentService/DeleteEnvironment"
	EnvironmentService_WatchEnvironment_FullMethodName  = "/blanketops.environments.v1beta1.EnvironmentService/WatchEnvironment"
)
...
func (UnimplementedEnvironmentServiceServer) PatchEnvironment(context.Context, *PatchEnvironmentRequest) (*PatchEnvironmentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatchEnvironment not implemented")
}
...
func (UnimplementedEnvironmentServiceServer) WatchEnvironment(*WatchEnvironmentRequest, grpc.ServerStreamingServer[WatchEnvironmentResponse]) error {
	return status.Errorf(codes.Unimplemented, "method WatchEnvironment not implemented")
}
...
var EnvironmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "blanketops.environments.v1beta1.EnvironmentService",
	...
	Metadata: "blanketops/environments/v1beta1/environment.proto",
}
