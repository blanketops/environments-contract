...
const file_blanketops_environments_v1_environment_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\v2-.blanketops.environments.v1.EnvironmentStatusR\x06status\"\xf1\x05\n" +
	...
	"deployment\x12E\n" +
	"\x05route\x18\t \x01(\v2/.blanketops.environments.v1.EnvironmentRouteRefR\x05route\x12K\n" +
	"\apackage\x18\n" +
	" \x01(\v21.blanketops.environments.v1.EnvironmentPackageRefR\apackage\x12E\n" +
	"\x05build\x18\v \x01(\v2/.blanketops.environments.v1.EnvironmentBuildRefR\x05build\x12]\n" +
	"\x0ebuild_triggers\x18\f \x03(\v26.blanketops.environments.v1.EnvironmentBuildTriggerRefR\rbuildTriggers\")\n" +
	...
	"\x18ENVIRONMENT_TYPE_TESTING\x10\x04BWZUgithub.com/ntlaletsi70/blanketops-environments-contract/blanketops/environments/v1;v1b\x06proto3"
...
var file_blanketops_environments_v1_environment_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_blanketops_environments_v1_environment_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_blanketops_environments_v1_environment_proto_goTypes = []any{
	(EnvironmentType)(0),               // 0: blanketops.environments.v1.EnvironmentType
	(*Environment)(nil),                // 1: blanketops.environments.v1.Environment
	(*EnvironmentSpec)(nil),            // 2: blanketops.environments.v1.EnvironmentSpec
	(*EnvironmentBuildRef)(nil),        // 3: blanketops.environments.v1.EnvironmentBuildRef
	(*EnvironmentBuildTriggerRef)(nil), // 4: blanketops.environments.v1.EnvironmentBuildTriggerRef
	(*EnvironmentServiceUnitRef)(nil),  // 5: blanketops.environments.v1.EnvironmentServiceUnitRef
	(*EnvironmentDeploymentRef)(nil),   // 6: blanketops.environments.v1.EnvironmentDeploymentRef
	(*EnvironmentRouteRef)(nil),        // 7: blanketops.environments.v1.EnvironmentRouteRef
	(*EnvironmentPackageRef)(nil),      // 8: blanketops.environments.v1.EnvironmentPackageRef
...
var file_blanketops_environments_v1_environment_proto_depIdxs = []int32{
	2,  // 0: blanketops.environments.v1.Environment.spec:type_name -> blanketops.environments.v1.EnvironmentSpec
	9,  // 1: blanketops.environments.v1.Environment.status:type_name -> blanketops.environments.v1.EnvironmentStatus
	0,  // 2: blanketops.environments.v1.EnvironmentSpec.environment_type:type_name -> blanketops.environments.v1.EnvironmentType
	5,  // 3: blanketops.environments.v1.EnvironmentSpec.service_units:type_name -> blanketops.environments.v1.EnvironmentServiceUnitRef
	6,  // 4: blanketops.environments.v1.EnvironmentSpec.deployment:type_name -> blanketops.environments.v1.EnvironmentDeploymentRef
	7,  // 5: blanketops.environments.v1.EnvironmentSpec.route:type_name -> blanketops.environments.v1.EnvironmentRouteRef
	8,  // 6: blanketops.environments.v1.EnvironmentSpec.package:type_name -> blanketops.environments.v1.EnvironmentPackageRef
	3,  // 7: blanketops.environments.v1.EnvironmentSpec.build:type_name -> blanketops.environments.v1.EnvironmentBuildRef
	4,  // 8: blanketops.environments.v1.EnvironmentSpec.build_triggers:type_name -> blanketops.environments.v1.EnvironmentBuildTriggerRef
