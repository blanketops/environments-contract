...
const file_blanketops_environments_v1_build_proto_rawDesc = "" +
	...
	"\x06status\x18\x02 \x01(\v2'.blanketops.environments.v1.BuildStatusR\x06status\"\xa2\x04\n" +
	"\tBuildSpec\x12\x14\n" +
...
var file_blanketops_environments_v1_build_proto_depIdxs = []int32{
	...
	14, // 9: blanketops.environments.v1.BuildSpec.duration:type_name -> google.protobuf.Timestamp
	0,  // 10: blanketops.environments.v1.BuildStrategy.kind:type_name -> blanketops.environments.v1.BuildStrategy.Kind
	8,  // 11: blanketops.environments.v1.BuildPolicy.allowed_triggers:type_name -> blanketops.environments.v1.BuildTriggerPolicy
	9,  // 12: blanketops.environments.v1.BuildPolicy.retry:type_name -> blanketops.environments.v1.RetryPolicy
	1,  // 13: blanketops.environments.v1.BuildTriggerPolicy.type:type_name -> blanketops.environments.v1.BuildTriggerPolicy.Type
	2,  // 14: blanketops.environments.v1.BuildStatus.phase:type_name -> blanketops.environments.v1.BuildStatus.Phase
	14, // 15: blanketops.environments.v1.BuildStatus.start_time:type_name -> google.protobuf.Timestamp
	14, // 16: blanketops.environments.v1.BuildStatus.completion_time:type_name -> google.protobuf.Timestamp
