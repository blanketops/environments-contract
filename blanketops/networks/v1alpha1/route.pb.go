...
// 	protoc        (unknown)
// source: blanketops/networks/v1alpha1/route.proto
...
var File_blanketops_networks_v1alpha1_route_proto protoreflect.FileDescriptor
...
const file_blanketops_networks_v1alpha1_route_proto_rawDesc = "" +
	...
	"\n" +
	"tls_status\x18\x04 \x01(\v2$.blanketops.common.v1.RouteTLSStatusR\ttlsStatus\x12L\n" +
	"\n" +
	"conditions\x18\x05 \x03(\v2,.blanketops.networks.v1alpha1.RouteConditionR\n" +
	"conditions\x12B\n" +
	...
	"\x14last_transition_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x12lastTransitionTime\"Q\n" +
	"\x12CreateRouteRequest\x12;\n" +
	"\x04spec\x18\x01 \x01(\v2'.blanketops.networks.v1alpha1.RouteSpecR\x04spec\"P\n" +
	"\x13CreateRouteResponse\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\"%\n" +
	"\x0fGetRouteRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"M\n" +
	"\x10GetRouteResponse\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\"O\n" +
	"\x12UpdateRouteRequest\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\"P\n" +
	"\x13UpdateRouteResponse\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\"=\n" +
	"\x11PatchRouteRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05patch\x18\x02 \x01(\tR\x05patch\"O\n" +
	"\x12PatchRouteResponse\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\"\xae\x02\n" +
	...
	"\x06routes\x18\x01 \x03(\v2#.blanketops.networks.v1alpha1.RouteR\x06routes\x12+\n" +
	...
	"\x12WatchRouteResponse\x129\n" +
	"\x05route\x18\x01 \x01(\v2#.blanketops.networks.v1alpha1.RouteR\x05route\x123\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1f.blanketops.common.v1.EventTypeR\x04type2\xaa\x06\n" +
	"\fRouteService\x12r\n" +
	"\vCreateRoute\x120.blanketops.networks.v1alpha1.CreateRouteRequest\x1a1.blanketops.networks.v1alpha1.CreateRouteResponse\x12i\n" +
	"\bGetRoute\x12-.blanketops.networks.v1alpha1.GetRouteRequest\x1a..blanketops.networks.v1alpha1.GetRouteResponse\x12r\n" +
	"\vUpdateRoute\x120.blanketops.networks.v1alpha1.UpdateRouteRequest\x1a1.blanketops.networks.v1alpha1.UpdateRouteResponse\x12o\n" +
	"\n" +
	"PatchRoute\x12/.blanketops.networks.v1alpha1.PatchRouteRequest\x1a0.blanketops.networks.v1alpha1.PatchRouteResponse\x12o\n" +
	"\n" +
	"ListRoutes\x12/.blanketops.networks.v1alpha1.ListRoutesRequest\x1a0.blanketops.networks.v1alpha1.ListRoutesResponse\x12r\n" +
	"\vDeleteRoute\x120.blanketops.networks.v1alpha1.DeleteRouteRequest\x1a1.blanketops.networks.v1alpha1.DeleteRouteResponse\x12q\n" +
	"\n" +
	"WatchRoute\x12/.blanketops.networks.v1alpha1.WatchRouteRequest\x1a0.blanketops.networks.v1alpha1.WatchRouteResponse0\x01B\xa8\x01\n" +
	"\x1cv1alpha1.networks.blanketopsB\n" +
	"RouteProtoZ]github.com/ntlaletsi70/blanketops-environments-contract/blanketops/networks/v1alpha1;v1alpha1\xaa\x02\x1cBlanketOps.Networks.v1Alpha1b\x06proto3"

var (
	file_blanketops_networks_v1alpha1_route_proto_rawDescOnce sync.Once
	file_blanketops_networks_v1alpha1_route_proto_rawDescData []byte
)

func file_blanketops_networks_v1alpha1_route_proto_rawDescGZIP() []byte {
	file_blanketops_networks_v1alpha1_route_proto_rawDescOnce.Do(func() {
		file_blanketops_networks_v1alpha1_route_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_blanketops_networks_v1alpha1_route_proto_rawDesc), len(file_blanketops_networks_v1alpha1_route_proto_rawDesc)))
	})
...
func file_blanketops_networks_v1alpha1_route_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_blanketops_networks_v1alpha1_route_proto_goTypes,
		DependencyIndexes: file_blanketops_networks_v1alpha1_route_proto_depIdxs,
		MessageInfos:      file_blanketops_networks_v1alpha1_route_proto_msgTypes,
	}.Build()
	File_blanketops_networks_v1alpha1_route_proto = out.File
	file_blanketops_networks_v1alpha1_route_proto_goTypes = nil
	file_blanketops_networks_v1alpha1_route_proto_depIdxs = nil
}
