...
func (UnimplementedRouteServiceServer) PatchRoute(context.Context, *PatchRouteRequest) (*PatchRouteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PatchRoute not implemented")
}
...
func (UnimplementedRouteServiceServer) WatchRoute(*WatchRouteRequest, grpc.ServerStreamingServer[WatchRouteResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchRoute not implemented")
}
